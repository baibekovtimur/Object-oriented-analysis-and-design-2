...
from .iterator_pattern import Aggregate, NearestUsersIterator, Recommendation
from .models import INTEREST_CATEGORIES, User, UserPoint, UserToPointMapper


class UserPointSpace(Aggregate[Recommendation]):
    """Aggregate that stores users and their positions in 2D space."""
...
def create_seeded_space() -> UserPointSpace:
    """Creates initial data so recommendations are visible on startup."""
